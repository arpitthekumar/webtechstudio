  ...
  const plans = [
    ...
    },
    {
      ...
      hardware: [
        ...
        { name: "Touch POS Machine", link: "https://example.com/pos-machine" },
      ],
      features: [
    ...
    },
    {
      ...
      lifetime: "₹59,999",
      hardware: [
        { name: "Complete POS Kit", link: "https://example.com/complete-kit" },
        { name: "Smart ID Scanner", link: "https://example.com/id-scanner" },
        { name: "Biometric Machine", link: "https://example.com/biometric" },
      ],
      features: [
