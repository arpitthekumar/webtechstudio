...
const HomePage: React.FC = () => {
  return (
    <>
      {/* ✅ SEO Metadata */}
      <Head>
        <title>WebTechStudio - Leading Web Development Agency in Agra, India</title>
        <meta name="description" content="WebTechStudio is a top web development agency in Agra, India, specializing in modern websites, UI/UX design, and SEO-friendly web solutions." />
        <meta name="keywords" content="Web Development, UI/UX Design, SEO, Web Design, Agra, India, WebTechStudio" />
        <meta name="author" content="WebTechStudio" />

        {/* ✅ Open Graph (For Social Media) */}
        <meta property="og:title" content="WebTechStudio - Leading Web Development Agency in Agra, India" />
        <meta property="og:description" content="Get high-quality websites and digital solutions from WebTechStudio, the top web development company in Agra, India." />
        ...
        <meta name="twitter:title" content="WebTechStudio - Leading Web Development Agency in Agra, India" />
        <meta name="twitter:description" content="We create high-performing websites and digital solutions for businesses of all sizes in Agra, India." />
