...
const Footer = () => {
  const links = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Instagram",
          href: "https://www.instagram.com/web.tech.studio?igsh=bnE5bnc5b3E0NGkz",
        },
  ...
  const socialIcons = [
    ...
    {
      icon: <FaInstagram />,
      href: "https://www.instagram.com/web.tech.studio/",
      label: "Instagram",
    },
    { icon: <FaLinkedinIn />, href: "https://www.linkedin.com/company/webtechstudio/", label: "LinkedIn" },
    {
      icon: <FaYoutube />,
      href: "https://www.youtube.com/@WebTechStudio-y8c",
      label: "YouTube",
    },
